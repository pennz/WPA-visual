...
binder_after_run:
	...
	make er
test_chart:
	curl -H "Content-Type: application/json" -X POST -d '{"infile":{"title": \
{"text": "Steep Chart"}, "xAxis": {"categories": ["Jan", "Feb", "Mar"]}, \
"series": [{"data": [29.9, 71.5, 106.4]}]}}' \
https://ancient-thicket-34735.herokuapp.com -o test_output.png
